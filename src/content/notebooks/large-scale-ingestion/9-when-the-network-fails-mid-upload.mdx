...
Redraw Part II from memory | Frontend, API, presigned URLs, parts, retries, complete. Then check against <Ref to="#7-multipart-and-resumable-upload">section 7</Ref>.
