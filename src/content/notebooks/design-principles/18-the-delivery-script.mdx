...
| Follow-up | Go to |
|---|---|
| "Give me an example of a violation you fixed" | A real one. <Ref to="#15-the-smell-catalogue-what-a-violation-looks-like-in-a-diff">Section 15</Ref>'s smells |
| "Aren't these just excuses for over-engineering?" | <Ref to="#13-ocp-against-yagni-the-abstraction-you-did-not-need">Section 13</Ref>, rule of three |
