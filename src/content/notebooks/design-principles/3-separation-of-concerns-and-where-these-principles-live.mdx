...
studying one aspect of a subject in isolation is legitimate <Mint>not because the
other aspects are unimportant, but because a mind can only hold one at a time.</Mint>
...
<Ref to="#12-when-two-principles-disagree">section 12</Ref>: <Mint>the arrows should point inward.</Mint> Business logic must not import
...
Notebook 13 covers the layers themselves properly, including what belongs in a
