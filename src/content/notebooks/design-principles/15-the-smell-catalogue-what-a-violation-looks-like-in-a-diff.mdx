...
| An interface with one implementation, forever | (none) | <Ref to="#13-ocp-against-yagni-the-abstraction-you-did-not-need">Section 13</Ref>, not a violation but a cost |
