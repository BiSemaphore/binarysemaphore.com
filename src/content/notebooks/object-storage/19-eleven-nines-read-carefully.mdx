...
The number falls out of the shard arithmetic in <Ref to="#18-the-data-plane-replication-and-erasure-coding">section 18</Ref>: the probability that
...
account, because <Peach>the failure mode I am actually planning for is a bad deploy
or a compromised key, not a disk</Peach>."
