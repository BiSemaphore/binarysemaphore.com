...
started <Ref to="#8-failure-7-no-transaction-across-two-systems">section 8</Ref>: <Peach>if you never see the upload, how does your database learn
about it?</Peach>
...
`HEAD` is the right call because of <Ref to="#20-the-metadata-plane">section 20</Ref>: size, type and ETag live in the
