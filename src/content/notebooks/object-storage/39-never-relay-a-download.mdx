...
---
The rule from <Ref to="#7-failure-6-your-server-is-an-expensive-cdn">section 7</Ref>, restated where it matters most.
...
- **A worker per download.** <Ref to="#7-failure-6-your-server-is-an-expensive-cdn">Section 7</Ref>. A goroutine or event-loop slot spends
