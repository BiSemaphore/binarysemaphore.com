...
wrong, but because <Peach>nothing in it had been designed for the number of
participants it suddenly had.</Peach>
...
REST was not designed and then implemented. <Peach>It is a description, written in
2000, of why the web had survived the previous decade.</Peach> That ordering explains
