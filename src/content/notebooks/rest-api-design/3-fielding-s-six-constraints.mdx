...
scaling story you have ever heard is downstream of this constraint. <Ref to="/scaling">Notebook 06</Ref>
<Ref to="#12-versioning-what-actually-forces-a-v2">section 12</Ref> covers what it costs and where sessions actually go; <Ref to="/real-time-backends">Notebook 07</Ref> is
...
Sub-constraint (d) is the one nobody implements, and it gets <Ref to="#5-the-constraint-nobody-implements">section 5</Ref> to itself.
...
05</Ref> <Ref to="#22-204-and-when-an-empty-body-is-wrong">section 22</Ref> covers the token side properly.
