...
- <Mint>Generate filenames server-side</Mint>, never from user input. <Ref to="/object-storage">Notebook 02</Ref>
  <Ref to="#15-jwt-what-you-gain-and-what-you-give-up">section 15</Ref> makes the same argument for object keys.
