...
The browser sees an image tag, issues the GET, and <Peach>attaches your bank cookies
because they belong to that domain</Peach>. Your bank sees a fully authenticated
...
- <Mint>`SameSite=Lax`</Mint> on session cookies, which is the modern browser default
