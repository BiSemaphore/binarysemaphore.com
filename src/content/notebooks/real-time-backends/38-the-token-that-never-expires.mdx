...
1. **A connection deadline.** Close with 4001 on expiry and let the client
   re-ticket. The reconnect is cheap because you built <Ref to="#32-the-catch-up-protocol">section 32</Ref>.
...
<Ref to="/security">Notebook 05</Ref> on authorisation applies unchanged; <Peach>what is new is that the check
