...
attached to the wrong number, and <Ref to="#4-the-arithmetic-of-polling">section 4</Ref> does that arithmetic.
...
the reconnect-and-refetch path in <Ref to="#32-the-catch-up-protocol">section 32</Ref> is polling with a longer interval.
