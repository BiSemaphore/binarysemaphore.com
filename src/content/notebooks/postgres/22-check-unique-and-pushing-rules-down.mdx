...
Every rule you can express here is a rule that <Peach>holds against every writer for
the life of the table</Peach>, including the migration you run at 2am and the script a
