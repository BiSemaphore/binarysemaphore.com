...
directly in the query from <Ref to="#28-dynamic-filters-and-sorts-without-opening-a-hole">section 28</Ref>.
...
<Peach>Any function applied to the column in the `WHERE` clause disables a plain
index</Peach>, whether that is `lower()`, a cast, or `ILIKE`. Either index the
