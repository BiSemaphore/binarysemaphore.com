...
---
Section 2's bug, now with a real database, because <Peach>a transaction alone does not
fix it</Peach>.
...
conditionally on it, and fail loudly if you lost</Peach>. Notebook 02 section 22 is the
