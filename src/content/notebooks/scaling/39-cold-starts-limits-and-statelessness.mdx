...
<Ref to="#24-statelessness-is-the-price-of-admission">Section 24</Ref> recommended statelessness. Serverless makes it mandatory, and this is
...
three hundred. <Peach>The connection ceiling from <Ref to="#15-connections-are-not-free">section 15</Ref> arrives all at once</Peach>,
