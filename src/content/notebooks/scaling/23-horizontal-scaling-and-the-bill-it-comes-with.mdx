...
<Peach>Distributed systems do not remove problems. They trade one set of problems for
another.</Peach> You give up "my server is too small" and receive "my servers disagree
...
you did not scale. <Peach>Horizontal scaling of the stateless tier relocates the
bottleneck to the stateful tier</Peach>, which is what Part VI is about.
