...
politely capped at 150. But the cap is per process, and <Peach>the autoscaler adds
processes</Peach>. Traffic spikes, Kubernetes helpfully adds a third replica, the
...
200 on the same hardware. This is the utilization knee from <Ref to="#5-utilization-and-the-knee">section 5</Ref>, wearing a
different hat.
